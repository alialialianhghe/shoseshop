		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-5 col-lg-5">
                    ...
                    @endif
					<form action="{{route('check_signup')}}" method="post" class="signin-form">
                        @csrf
{{--                        hoten--}}
...
{{--                        quyen--}}
                        ...
                        <div class="form-group mb-3">
                            <label class="label" for="username">Tên Tài Khoản</label>
                            <input type="text" class="form-control" placeholder="Nhập tên tài khoản" name="username" required>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <label class="label" for="confirm">Xác Nhận Mật Khẩu</label>
                            <input type="password" class="form-control" placeholder="Xác nhận mật khẩu" name="confirm" required>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <label class="label" for="address">Số điện thoại</label>
